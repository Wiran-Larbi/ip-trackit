...
export function Modal({address}) {
    ...
    return <>
        <article className="bg-white rounded-lg shadow p-8 grid gap-8 hover:shadow-2xl transition duration-300 mt-6 sm:mx-8 sm:grid-cols-1 sm:gap-8 md:grid-cols-2 md:gap-8 lg:grid-cols-4 lg:max-w-6xl lg:mx-auto text-center md:text-left">
