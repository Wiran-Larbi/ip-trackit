...
export function ProfileMenu() {
    ...
    return (
        <>
            <button
                type="button"
                className="relative rounded-full p-1 text-trademark hover:text-cyan-500 focus:outline-none sm:inline-block hidden "
            >
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <Menu.Item>
                            {({ active }) => (
                                <a
                                    href="#"
                                    className={classNames(active ? 'hover:bg-blue-100 transition duration-300' : '', 'block px-4 py-2 text-sm text-gray-700')}
                                >
                                    Your Profile
                                </a>
                            )}
